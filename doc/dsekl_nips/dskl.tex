...
These results are comparable to \cite{Dai2014}, which also achieve a test error of also about 15\% after one iteration. 
...
%\sebastian{wäre viel besser gegen einen core zu vergleichen, dann sind auch die zahlen groesser :)}
