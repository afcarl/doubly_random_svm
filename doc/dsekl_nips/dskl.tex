...
%single host show that the proposed approximation achieves competitive results. Experiments with parallelized implementations demonstrate that the proposed approach enjoys scaling properties that allow to avoid the exponential scaling behaviour associated with kernel methods. 
